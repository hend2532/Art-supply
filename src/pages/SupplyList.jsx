...
function SupplyList() {
  ...
  return (
    <div className="mt-[100px] mb-[60px]">
      <h1 className=" la-belle-aurore-regular text-center m-5 mt-8 text-[25px] font-semibold text-customPink ">
      ...
      {ArtData.map((art) => (
        <Link  to={`/stockTracker/${art.id}`} key={art.id} className="flex flex-col shadow-customShadow cursor-pointer rounded-lg overflow-hidden p-3 duration-100 hover:scale-105">
          <img src={art.image} alt={art.name} className="w-36 h-40 mb-2" />
